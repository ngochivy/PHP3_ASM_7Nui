...
<style>
    ...
    .pagination-area .page-item.disabled .page-link {
        color: #ffc0d5;
        /* Màu nhạt khi disabled */
        background-color: white;
        border-color: #ffebf3;
    }

    .pagination-area .page-item:not(.active):not(.disabled) .page-link:hover {
    ...
    .pagination-area .page-item:last-child .page-link {
        border-radius: 50% !important;
        /* Đảm bảo nút prev/next cũng tròn */
    }
                            ...
                            <div class="product-showing-status">
                                <p class="count-result">
                                    @if(request()->has('query'))
                                        <span id="current-count">{{ count($products) }}</span> Sản phẩm tìm thấy cho từ khóa <strong>{{ request('query') }}</strong>
                                    @else
                                        <span id="current-count">{{ count($products) }}</span> Sản phẩm trong tổng số <span id="total-count">{{ count($products) }}</span>
                                    @endif
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="pagination-area mb-md-50">
                                    <nav>
                                        <ul class="page-numbers justify-content-end">
                                            ...
                                            <li><a class="page-number next" href="blog.html"><i class="fa fa-angle-right"></i></a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="product-sorting-menu product-sorting">
                            ...
                            <ul>
                                ...
                                <li class="{{ ($currentSort ?? '') == 'price_desc' ? 'active' : '' }}">
                                    <a href="?sort=price_desc">Sắp xếp theo giá giảm dần <i class="lastudioicon-arrow-up"></i></a>
                                </li>
                                <li class="{{ ($currentSort ?? '') == 'price_asc' ? 'active' : '' }}">
                                    <a href="?sort=price_asc">Sắp xếp theo giá tăng dần <i class="lastudioicon-arrow-down"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-info text-center">
                                            ...
                                            <h4 class="title">
                                                <a href="/product_detail/{{ $p->slug }}">{{ Str::limit($p->title, 40) }}</a>
                                            </h4>
                                            <div class="prices">
                                                <span class="old-price" style="text-decoration: line-through; color: gray;">{{ number_format($p->price) }}vnđ</span>
                                                <span class="new-price" style="color: red; font-weight: bold;">{{ number_format($p->price -  $p->sale_price) }}vnđ</span>
